...
export default function Shadow({panelNumber, shadow}) {
  ...
  return (
    <li className="bg-gray-50 border-b border-gray-300">
      <button
      className="px-6 py-4 w-full flex justify-between items-center hover:bg-gray-100"
      ...
      >
        ...
        className="font-bold w-5 transition"
        src={chevron} alt="" />
      </button>
      {
        toggleShadow && <>
        <div className="flex items-end px-6 py-4">
          ...
          <button
          className="ml-auto text-sm bg-red-600 text-white hover:bg-red-700 py-1 px-3 rounded transition"
          >
            Remove
          </button>
        </div>
